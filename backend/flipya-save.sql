...
DROP DATABASE flipya;
--
-- Name: flipya; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE flipya WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';
